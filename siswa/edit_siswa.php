...
$id_siswa = $_GET['id'];
$tampil = "SELECT * FROM siswa where Id_Siswa='$id_siswa'";
            ...
            <ul class="nav navbar-nav w-100 justify-content-between">
                ...
                <li class="nav-item">
                    ...
                    <div class="col-md-9 px-0 mt-2">
                        <div class="card-body">
                            <form class="form" role="form" autocomplete="off" action="proses_edit_siswa.php" method="POST">
                                
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label">ID SISWA</label>
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" placeholder="Masukkan ID Siswa" name="id_siswa" value="<?= $data['Id_Siswa']; ?>" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label">Nama Siswa</label>
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" placeholder="Masukkan Nama Siswa" name="nama_siswa" value="<?= $data['Nama_Siswa']; ?>" autofocus required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                           <select name="jenkel">
                                            <option value="NULL" <?php echo $data['Jenis_Kelamin'] == 'NULL' ? 'selected' : '' ?>>Pilihan</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" placeholder="Masukkan Tempat Lahir" name="tempat_lahir" value="<?=$data['Tempat_Lahir']?>" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label">Tanggal Lahir</label>
                                    <div class="col-lg-9">
                                        <input class="form-control" type="date" name="tanggal_lahir" value="<?=$data['Tanggal_Lahir']?>" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label">Alamat</label>
                                    <div class="col-lg-9">
                                       <textarea cols="60" rows="3" name="alamat"><?=$data['Alamat']?></textarea required>
                                    </div>
                                </div>
